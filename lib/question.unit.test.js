...
describe('question', () => {
  ...
  describe('.evaluateDifficulty', () => {
    ...
    describe('on fail', () => {
      it('must increate from 0,50 to 0,5500 for a user with score 0,50', test(0.50, 0.50, false, 0.5500) );
      it('must increate from 0,50 to 0,5375 for a user with score 0,25', test(0.50, 0.25, false, 0.5375) );
      it('must increate from 0,90 to 0,9020 for a user with score 0,10', test(0.90, 0.10, false, 0.9020) );
      it('must increate from 0,10 to 0,2620 for a user with score 0,90', test(0.10, 0.90, false, 0.2620) );
    });
